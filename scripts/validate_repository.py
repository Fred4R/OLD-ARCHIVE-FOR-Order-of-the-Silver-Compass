...
def validate_character_relationship_records(master_text: str) -> None:
    character_records = {
        ...
        "Characters/Aurelia-Montfort.md": "CHAR-AURELIA",
        "Characters/Justina-Voss.md": "CHAR-JUSTINA",
        "Characters/Eulalia-Veridica.md": "CHAR-EULALIA",
        "Characters/Valeria.md": "CHAR-VALERIA",
        "Characters/Helverin-Pilot.md": "CHAR-HELVERIN-PILOT",
        "Characters/Warhound-Princeps.md": "CHAR-PRINCEPS",
        "Characters/Paragon-Trio.md": "CHAR-PARAGON-TRIO",
    }

    for rel, character_id in character_records.items():
        path = ROOT / rel
        if not path.exists():
            fail(f"Missing character continuity record: {rel}")
            continue

        text = read_text(path)
        if 'record_type: "character_continuity_record"' not in text:
...
def validate_connections() -> None:
    ...
    checks = {
        ROOT / "README.md": ["scripts/validate_repository.py", "Validate repository integrity", "CURRENT_STATE.md", "NEW_CONVERSATION.md", "Characters/", "Relationships/RELATIONSHIPS.md"],
        ROOT / "AGENTS.md": ["scripts/validate_repository.py", "CURRENT_STATE.md", "CONTINUATION.md", "NEW_CONVERSATION.md", "Characters/", "Relationships/RELATIONSHIPS.md"],
        ROOT / "AUTHORITY.md": ["scripts/validate_repository.py", "CURRENT_STATE.md", "CONTINUATION.md", "NEW_CONVERSATION.md", "Characters/", "Relationships/RELATIONSHIPS.md"],
        ROOT / "CURRENT_STATE.md": [
            "Current live scene",
        ...
        ROOT / "NEW_CONVERSATION.md": ["CURRENT_STATE.md", "Characters/", "Relationships/RELATIONSHIPS.md", "Rules/11e/SOURCE_INDEX.md", "CONTINUATION.md", "USING_REPOSITORY.md"],
        ROOT / "USING_REPOSITORY.md": ["CURRENT_STATE.md", "Characters/", "Relationships/RELATIONSHIPS.md", "AUTHORITY.md", "STATUS.md"],
...
def main() -> int:
    ...
    validate_character_relationship_records(master_text)
    ...
    print("current-claim provenance, character/relationship extraction boundaries,")
